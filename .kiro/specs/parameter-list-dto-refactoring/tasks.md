...
- [ ] 1. Create new DTO classes in Application/Contracts
  - [x] 1.1 Create TrySendEmailRequest and SendEmailRequest in Application/Contracts/Email
  ...
  - [x] 1.2 Create RegisterRequest in Application/Contracts/Auth
  ...
  - [x] 1.3 Create UserQueryParams in Application/Contracts/Users
...
- [ ] 2. Refactor IEmailService and EmailService (TrySendEmailAsync and SendEmailAsync)
  - [x] 2.1 Update IEmailService interface signatures
  ...
  - [x] 2.2 Update EmailService implementation for SendEmailAsync
  ...
  - [x] 2.3 Update EmailService implementation for TrySendEmailAsync
  ...
  - [x] 2.4 Update all callers of TrySendEmailAsync (RegisterService, UserService, LoginService)
    - Update each caller to construct a `TrySendEmailRequest` instance instead of passing individual parameters
    - _Requirements: 1.4_

  - [x] 2.5 Update Identity integration methods calling SendEmailAsync
...
- [x] 3. Refactor ILoginService and LoginService
  - [x] 3.1 Update ILoginService interface signature
  ...
  - [x] 3.2 Update LoginService implementation
  ...
  - [x] 3.3 Update AuthController caller for LoginService
...
- [x] 4. Refactor ILdapLoginService and LdapLoginService
  - [x] 4.1 Update ILdapLoginService interface signature
    - Change `ValidateAndGenerateTokenAsync` to accept a single `LoginRequest` parameter (reuse existing `Application/Contracts/Auth/LoginRequest`)
    - Remove old 4-parameter signature
    - _Requirements: 3.1, 3.6_

  - [x] 4.2 Update LdapLoginService implementation
  ...
  - [x] 4.3 Update AuthController caller for LdapLoginService
...
- [x] 6. Refactor IRegisterService and RegisterService
  - [x] 6.1 Update IRegisterService interface signature
    - Change `RegisterUserAsync` to accept a single `RegisterRequest` parameter
    - Remove old 4-parameter signature
    - _Requirements: 4.1_

  - [x] 6.2 Update RegisterService implementation
  ...
  - [x] 6.3 Update AuthController caller for RegisterService
...
- [x] 7. Refactor IUserService.SearchAsync and related callers
  - [x] 7.1 Update IUserService interface signature
    - Change `SearchAsync` to accept a single `UserQueryParams` parameter
    - Remove old 3-parameter signature
    - _Requirements: 5.1_

  - [x] 7.2 Update UserService implementation
  ...
  - [x] 7.3 Update UsersController to bind UserQueryParams from query string
    - Use `[FromQuery]` to bind query string parameters to the `UserQueryParams` DTO and pass to the service
    - _Requirements: 5.4_

  - [x] 7.4 Update ApiUserService (Web project) to accept UserQueryParams
...
- [ ] 8. Refactor ApiAuthService (Web project) — ResetPasswordAsync and ConfirmEmailAsync
  - [x] 8.1 Update ApiAuthService.ResetPasswordAsync to accept ResetPasswordRequest DTO
  ...
  - [x] 8.2 Update ApiAuthService.ConfirmEmailAsync to accept ConfirmEmailRequest DTO
