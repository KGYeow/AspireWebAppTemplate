...
- [x] 1. Extend NotificationPushRequest DTO and API service
  - [x] 1.1 Add NotificationId property to NotificationPushRequest
  ...
  - [x] 1.2 Set NotificationId in NotificationService.CreateNotificationAsync
...
- [x] 2. Update NotificationCallbackEndpoint validation and SignalR invocation
  - [x] 2.1 Add Guid.Empty validation for NotificationId
  ...
  - [x] 2.2 Extend SignalR SendAsync to include notificationId as 5th parameter
...
- [x] 3. Create NotificationReceivedEventArgs and update NotificationContext
  - [x] 3.1 Create NotificationReceivedEventArgs class
  ...
  - [x] 3.2 Update INotificationContext event signature
  ...
  - [x] 3.3 Update NotificationContext hub handler to 5-param registration
...
- [x] 5. Update NotificationBell event handler and snackbar deep link
  - [x] 5.1 Update HandleNotificationReceived to accept NotificationReceivedEventArgs
  ...
  - [x] 5.2 Update ShowToast to accept notificationId and configure deep link onclick
...
- [x] 6. Write property-based and unit tests
  - [x] 6.1 Write property test for push request carrying entity ID
  ...
  - [x] 6.2 Write property test for endpoint forwarding all parameters
  ...
  - [x] 6.3 Write property test for hub event args population
  ...
  - [x] 6.4 Write property test for deep link URL construction
  ...
  - [x] 6.5 Write unit tests for NotificationCallbackEndpoint validation
