...
namespace AspireWebAppTemplate.Infrastructure.Services.Authentication;
...
public sealed class RegisterService : IRegisterService
{
    ...
    public async Task<RegisterResult> RegisterUserAsync(RegisterRequest request)
    {
        ...
        await _emailService.TrySendEmailAsync(new Application.Features.Email.TrySendEmailRequest
        {
            UserId = userId,
