...
using AspireWebAppTemplate.Infrastructure.Services.Users;
...
/// <summary>
/// Extension methods for registering infrastructure-layer business services
/// (scoped and singleton) used by the API controllers.
/// </summary>
public static class InfrastructureServiceExtensions
{
    /// <summary>
    /// Registers all infrastructure business services including the current user accessor,
